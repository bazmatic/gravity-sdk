...
use gaptos::aptos_num_variants::NumVariants;
use gaptos::aptos_short_hex_str::AsShortHexStr;
use gaptos::aptos_time_service::{TimeService, TimeServiceTrait};
use gaptos::aptos_types::{account_address::AccountAddress, network_address::NetworkAddress, PeerId};
use futures::{
    channel::oneshot,
...
pub struct ConnectivityManager<TBackoff> {
    ...
    requests_rx: gaptos::aptos_channels::Receiver<ConnectivityRequest>,
