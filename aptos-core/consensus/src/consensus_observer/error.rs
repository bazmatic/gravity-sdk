...
use gaptos::aptos_network::protocols::network::RpcError;
use thiserror::Error;
...
impl From<gaptos::aptos_network::application::error::Error> for Error {
    fn from(error: gaptos::aptos_network::application::error::Error) -> Self {
